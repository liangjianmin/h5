    ...
    <section class="dola-invest_success pro__success boxsiz" :class="{isApp:isApp}" v-if="balanceInfo.balance_info">
        ...
        <ul class="txt boxsiz">
            <li class="clr">
                ...
                <p class="fr t2"><span>{{transfer_money}}</span>元</p>
            </li>
            <li class="clr">
                <p class="fl t1">投资期限</p>
                <p class="fr t2"><span>{{invest_date}}</span></p>
            </li>

            <li class="clr">
                <p class="fl t1">往期年化收益率</p>
                <p class="fr t2"><span>{{invest_rate}}</span>%</p>
            </li>
            <li class="clr">
                <p class="fl t1">往期参考收益</p>
                <p class="fr t2"><span>{{history_interest}}</span>元</p>
            </li>
            <li class="clr">
                <p class="fl t1">到期时间</p>
                <p class="fr t2"><span>{{due_day}}</span></p>
            </li>
        </ul>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            transfer_money() {
                return this.$route.query.transfer_money;
            },
            accept_money() {
                return this.$route.query.accept_money;
            },
            wait_pay_interest() {
                return this.$route.query.wait_pay_interest;
            },
            history_interest() {
                return this.$route.query.history_interest;
            },
            principal_interest() {
                return this.$route.query.principal_interest;
            },
            due_day() {
                return this.$route.query.due_day;
            },
            invest_rate() {
                return this.$route.invest_rate;
            }
        },
        created() {
