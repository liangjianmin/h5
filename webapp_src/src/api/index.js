...
switch (window.location.hostname) {
    ...
    case "www.dola.dev":
        ...
        break;
    case "www.dola.cn":
        urlApi = 'https://api.dola.cn/';
        url = 'https://www.dola.cn/';
        break;
    default:
        urlApi = 'https://www.dolabank.com/apigateway/';
        url = 'https://www.dolabank.com/';
...
export const apis = {
   ...
   */
     ...
     * 新-优惠券列表
     */
    userCouponRecordInfo: productionUrlApi + 'v1/user_coupon/user_coupon_record_info',
    /**
     * 新手标详情
     */
    noviceDetail: productionUrlApi + 'v1/loan/novice_detail',
    /**
     * 运营报告
     */
    getOperationReportsNew: productionUrlApi + 'v1/homepage/getOperationReportsNew',
    /**
     * 运营报告实时
     */
    getOperationReportsT1: productionUrlApi + 'v1/homepage/getOperationReportsT1',
    /**
     * 余额复投--配置
     */
    getBalanceInfo: productionUrlApi + 'v1/user_balance/get_info',
    /**
     * 余额复投--开启
     */
    setBalanceOpen: productionUrlApi + 'v1/user_balance/set_open',
    /**
     * 余额复投--关闭
     */
    setBalanceClose: productionUrlApi + 'v1/user_balance/set_close'
}
...
export const services = {
    ...
    unbindBankcardApply(Codekey, params) {
        return axios.post(apis.unbindBankcardApply, {data: params}, {
            headers: {
                'X-Dola-Code': Codekey
            }
        })
    ...
    userCouponRecordInfo(Codekey, params) {
        return axios.get(apis.userCouponRecordInfo, {
            params: {
                data: params
            },
            headers: {
    ...
    noviceDetail(Codekey, params) {
        return axios.get(apis.noviceDetail, {
            params: {
                data: params
            },
            headers: {
    ...
    getOperationReportsNew(Codekey, params) {
        return axios.get(apis.getOperationReportsNew, {
            params: {
                data: params
            },
            headers: {
    ...
    getOperationReportsT1(Codekey, params) {
        return axios.get(apis.getOperationReportsT1, {
            params: {
                data: params
            },
            headers: {
    ...
    getBalanceInfo(Codekey, params) {
        return axios.get(apis.getBalanceInfo, {
            params: {
                data: params
            },
            headers: {
    ...
    setBalanceOpen(Codekey, params) {
        return axios.get(apis.setBalanceOpen, {
            params: {
                data: params
            },
            headers: {
    ...
    setBalanceClose(Codekey, params) {
        return axios.get(apis.setBalanceClose, {
            params: {
                data: params
            },
            headers: {
